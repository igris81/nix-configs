		...
		settings = {
            ...
            #* KEYBINDS
  			bind = [
				...
				# VOLUME
				",XF86AudioLowerVolume, exec, pactl set-sink-volume 0 -3%   # VOLUME"
				",XF86AudioRaiseVolume, exec, pactl set-sink-volume 0 +3%   # VOLUME"
				",XF86AudioMute, exec, pactl set-sink-mute 0 toggle         # VOLUME"
				# Microphone
				"$mainMod, XF86AudioMute, exec, pactl set-source-mute @DEFAULT_SOURCE@ toggle   # Microphone"
  			];
			bindm = [
